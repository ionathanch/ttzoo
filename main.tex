...
%
\begin{align*}
    \case ~ P ~ (c_j ~ \Vec{a}) ~ \of ~ \langle c_i \Rightarrow d_i \rangle_i &\rhd_\iota d_j ~ \Vec{a} \\
    \match ~ x.\Vec{y}.P ~ (c_j ~ \Vec{a}) ~ \with ~ \langle c_i ~ \Vec{z}_i \Rightarrow d_i \rangle_i &\rhd_\iota d_j[\Vec{z}_j \mapsto \Vec{a}]
\end{align*}
...
\begin{mathpar}
    \inferrule*[right=case-uniq]{
        ...
        \Gamma \vdash \case ~ P ~ t ~ \of ~ \langle c_i \Rightarrow \lambda \Delta_i. ~ d[x \mapsto c_i ~ \Delta_i] \rangle_i \equiv d[x \mapsto t] : P ~ \Vec{e} ~ t
    }
    ...
    \inferrule*[right=match-uniq]{
        ...
        \Gamma \vdash \match ~ x.\Vec{y}.P ~ t ~ \of \langle c_i ~ \Vec{z}_i \Rightarrow d[x \mapsto c_i ~ \Vec{z}] \rangle_i \equiv d[x \mapsto t] : P[x \mapsto t][\Vec{y} \mapsto \Vec{e}]
    }
\end{mathpar}
...
\begin{mathpar}
    \inferrule*[right=case-$\eta_1$]{
        ...
        \and
        \Gamma \vdash d_i \equiv c_i : \Delta_i \to I ~ \Vec{p} ~ \Vec{e}
        \and
    ...
    \inferrule*[right=match-$\eta_1$]{
        ...
        \Gamma \vdash e_2 \rhd^* e_2'
        \and
        \Gamma \Delta_i \vdash d_i[\Vec{z}_i \mapsto \Delta_i] \equiv c_i ~ \Delta_i : I ~ \Vec{p} ~ \Vec{e}
        \and
        \Gamma \vdash e_1' \equiv e_2' : I ~ \Vec{p} ~ \Vec{e}
    }{
        \Gamma \vdash e_1 \equiv e_2 : I ~ \Vec{p} ~ \Vec{e}
